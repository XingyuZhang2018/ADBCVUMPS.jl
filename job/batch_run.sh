...
for i in $(seq 0.125 0.025 0.3); do cp K-1.0_gamma0.0_D${D}_chi${chi}_f0.0 K-1.0_gamma${i}_D${D}_chi${chi} && sed -i "7s/0.0/$i/2" K-1.0_gamma${i}_D${D}_chi${chi}; done
...
for i in $(seq 0.125 0.025 0.3); do qsub -V K-1.0_gamma${i}_D${D}_chi${chi}; done
for i in $(seq 0.125 0.025 0.3); do rm K-1.0_gamma${i}_D${D}_chi${chi}; done
