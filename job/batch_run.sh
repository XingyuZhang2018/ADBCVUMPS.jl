...
for i in $(seq 0.03 0.02 0.17); do cp K-1.0_J-0.1_G0.3_Gp-0.02_D4_chi80_f0.0 K-1.0_J-0.1_G0.3_Gp-0.02_D4_chi80_f${i} && sed -i "7s/0.0/$i/2" K-1.0_J-0.1_G0.3_Gp-0.02_D4_chi80_f${i}; done
...
for i in $(seq 0.03 0.02 0.17); do qsub -V K-1.0_J-0.1_G0.3_Gp-0.02_D4_chi80_f${i}; done
for i in $(seq 0.03 0.02 0.17); do rm K-1.0_J-0.1_G0.3_Gp-0.02_D4_chi80_f${i}; done
