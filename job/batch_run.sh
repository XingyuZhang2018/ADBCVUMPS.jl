...
for i in $(seq 5.0 5.0 355.0); do cp degree0.0_D${D}_chi${chi} degree${i}_D${D}_chi${chi} && sed -i "7s/0.0/$i/g" degree${i}_D${D}_chi${chi}; done

# grep degree *_chi${chi}

for i in $(seq 0.0 5.0 355.0); do qsub -V degree${i}_D${D}_chi${chi}; done
